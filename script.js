let taskId = 1; //Valor inicial para a id das Li
...
function NewTask() {
  ...
  liElement.innerHTML = `<button class="btn-task"onclick="Taskcompt(this.parentNode)">
  <i class="bi bi-check-circle-fill"></i>
  </button> <p class="risco">${newtext}</p> <button class="btn-Trash" onclick="RemoveTask(this.parentNode)">
...
function RemoveTask(taskElement) {
  ...
  textAlertbox.innerHTML = "Task Removida !";
  alertbox.style.display = 'flex';
